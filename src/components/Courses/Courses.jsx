...
const Courses = () => {
    ...
    return (
      <div className="grid grid-rows-2 grid-flow-col">
        <div className="row-span-4 border-r">
          <h1 className="text-center text-2xl pb-3 border-b pt-4 italic text-orange-500">Course List</h1>
        ...
        <div className="row-span-8 w-full">
          <Marquee className="text-center text-2xl py-5 text-orange-500">
            Belieav And Respect Your Goal.Do Hard Work And Show What You Can Do.
          </Marquee>
